  ...
  return (
    <div className="relative bg-gray-900 text-white rounded-lg shadow-md overflow-hidden mb-4 w-60 h-[260px] transform transition-transform duration-200 hover:scale-105">
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M14.752 11.168l-5.586 3.162A1 1 0 018 13.517V8.485a1 1 0 011.166-.986l5.586 1.998a1 1 0 01.586.913v2.758a1 1 0 01-.586.913z" />
          </svg>
        </button>
      </div>
      ...
      <div className="p-3 h-[80px] flex flex-col justify-between">
        {/* Title with a fixed height to prevent shifting */}
        <h3 className="text-sm font-semibold text-white ">{title}</h3>

        {/* Bottom Section (Username & Views) - Lowered More */}
